...
public class SiteFileFetch extends Thread{
    ...
    public SiteFileFetch(SiteInfoBean bean,IStatusCallBack callBack) throws IOException
    {
        siteInfoBean = bean;
    ...
    public void run()
    {
        ...
        {
            isLoading = false;
            callBack.call(DOWNLOAD_ERROR,0);
        }
    }
    ...
    private void gatherLoadProgress()
    {
        ...
        callBack.call(DOWNLOADING,percent);
